...
>>>>>>> 9fe7849f5ddce186d8e75b87bea078da380dd798

In this setting, we want a kernel $k$ to be dependent on which parameters are relevant, and the values of relevant parameters for both points. For example, suppose we have first-layer parameters $x_1$ and $x_1'$:
%
\begin{itemize}
